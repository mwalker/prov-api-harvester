...
class ProvConfigApp(App):
    ...
    BINDINGS = [
        ...
        Binding("shift+j", "scroll_detail_down", "Detail↓", show=True, key_display="J"),
        Binding("shift+k", "scroll_detail_up", "Detail↑", show=True, key_display="K"),
    ...
    def __init__(
        ...
        self.filter_text = ""
        self._dirty = False
        self.view_mode = "agencies"  # "agencies" or "series"
    ...
    def _update_detail(self) -> None:
        ...
        if self.view_mode == "agencies":
            ...
            # Function/Content and How to Use
